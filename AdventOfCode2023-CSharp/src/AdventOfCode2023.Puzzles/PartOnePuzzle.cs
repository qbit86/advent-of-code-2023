...
public static class PartOnePuzzle
{
    ...
    private static ConditionRecord Parse(string line)
    {
        ...
        StringTokenizer groupTokenizer = new(parts[0], s_groupSeparators);
        ...
        foreach (StringSegment segment in lengthTokenizer)
        {
            ...
            actualLengths.Add(groupLength);
        }

        ReadOnlyMemory<int> actualLengthsMemory = actualLengths.ToArray();
